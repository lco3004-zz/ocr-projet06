...
CREATE INDEX `fk_commentaire_user1_idx` ON `commentaire` (`user_iduser` ASC);
...
INSERT INTO `topo` (`idtopo`, `user_iduser`, `nom`, `est_publie`, `est_disponible`, `resume`, `lieu`,
                    `date_de_parution`)
VALUES (DEFAULT, 1, 'topo_01', 1, 1, 'resume_topo_01', 'lieu_01', '2019-10-21');
INSERT INTO `topo` (`idtopo`, `user_iduser`, `nom`, `est_publie`, `est_disponible`, `resume`, `lieu`,
                    `date_de_parution`)
VALUES (DEFAULT, 2, 'topo_02', 1, 0, 'resume_topo_02', 'lieu_02', '2018-11-22');
INSERT INTO `topo` (`idtopo`, `user_iduser`, `nom`, `est_publie`, `est_disponible`, `resume`, `lieu`,
                    `date_de_parution`)
VALUES (DEFAULT, 2, 'topo_03', 1, 1, 'resume_topo_03', 'lieu_03', '2017-12-23');
