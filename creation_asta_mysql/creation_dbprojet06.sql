...
CREATE TABLE IF NOT EXISTS `topo` (
                                      ...
                                      `est_publie`       INT          NOT NULL DEFAULT 0,
                                      `est_disponible`   INT          NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `commentaire` (
                                             ...
                                             `est_visible`   INT          NOT NULL DEFAULT 1,
...
INSERT INTO `topo` (`idtopo`, `user_iduser`, `nom`, `est_publie`, `est_disponible`, `resume`, `lieu`,
                    `date_de_parution`)
VALUES (DEFAULT, 2, 'topo_03', 1, 1, 'resume_topo_03', 'lieu_03', '2003-12-23');
...
VALUES (DEFAULT, 1, 'comment_0101', 1);
INSERT INTO `commentaire` (`idcommentaire`, `spot_idspot`, `texte`, `est_visible`)
VALUES (DEFAULT, 2, 'comment_0102', 1);
INSERT INTO `commentaire` (`idcommentaire`, `spot_idspot`, `texte`, `est_visible`)
VALUES (DEFAULT, 1, 'comment_0201', 1);
